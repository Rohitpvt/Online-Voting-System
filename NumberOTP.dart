...
//import 'package:votingappa/WelcomeScreen.dart';
  ...
  void _onResendCode() {
    ...
    auth.verifyPhoneNumber(
      ...
      verificationCompleted: (PhoneAuthCredential credential) async {
        // Automatically signs in when the code is verified
      ...
      verificationFailed: (FirebaseAuthException e) {
        setState(() {
          _statusMessage = 'Failed to send OTP: ${e.message}';
        });
      },
      codeSent: (String verificationId, int? resendToken) {
        setState(() {
          ...
          _isOTPSent = true; // Show the OTP input UI
        });
      },
    ...
    if (_verificationId != null && _otpCode.isNotEmpty) {
      try {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => ElectionScreen(phone: widget.phone)),
        );
      } catch (e) {
        setState(() {
      ...
      setState(() {
        _statusMessage = 'Please enter the OTP code.';
      });
    }
  }
                                ...
                                TextSpan(
                                  ...
                                  style: const TextStyle(
                                    ...
                                    fontWeight: FontWeight
                                        .bold, // Bold style for phone number
                                  ),
                                ),
                              ],
                            ),
